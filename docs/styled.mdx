...
`
const ReusedChild = styled(Child)`
...
render(
  <div>
    <Parent>
      ...
      <br />
      <ReusedChild>Green because I am also inside a Parent</ReusedChild>
    </Parent>
    <Child>Red because I am not inside a Parent</Child>
    <br />
    <ReusedChild>Red because I am also not inside a Parent</ReusedChild>
  </div>
)
```
