...
The ["@zedvision/emotion-react"](https://www.npmjs.com/package/@emotion/react) package requires React and is recommended for users of that framework if possible.
