...
**Before adopting Emotion into your project, we recommend reading our documentation on [The Cost on Runtime CSS-in-JS](/docs/performance#the-cost-of-runtime-css-in-js).**
