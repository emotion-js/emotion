...
You can still use the css helper and pass the className yourself.
...
import * as emotionTheming, { EmotionTheming } from 'emotion-theming'
...
const { ThemeProvider, withTheme, useTheme } = emotionTheming as EmotionTheming<Theme>
