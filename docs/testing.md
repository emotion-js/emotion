...
By default snapshots with emotion show generated class names. Adding [jest-emotion-react](https://github.com/emotion-js/emotion/tree/master/packages/jest-emotion-react) allows you to output the actual styles being applied. 
...
Your snapshot class names will now appear as `emotion-[0...n]`
