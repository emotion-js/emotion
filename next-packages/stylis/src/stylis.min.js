function M() {
  function N(d, c, e, h, a) {
    for (
      ...
      if (0 === b + n + v + m) {
        if (l === J && (0 < r && (f = f.replace(O, '')), 0 < f.trim().length)) {
          switch (g) {
            case 32:
            case 9:
            case 59:
    ...
    if (0 < t) {
      ...
      if (0 !== w * E) {
        ...
        switch (E) {
          ...
          case 112:
            p =
              p.replace(R, '::-webkit-input-$1') +
              p.replace(R, '::-moz-$1') +
              p.replace(R, ':-ms-input-$1') +
              p
        }
        E = 0
      }
      ...
      case 953:
        if (!0 === la.test(d))
          return 115 === (b = d.substring(d.indexOf(':') + 1)).charCodeAt(0)
            ? Q(d.replace('stretch', 'fill-available'), c, e, h).replace(
                ':fill-available',
                ':stretch'
              )
            : a.replace(b, '-webkit-' + b) +
  ...
  function L(d, c) {
    ...
    return S(2 !== c ? h : h.replace(na, '$1'), e, c)
  }
  function ea(d, c) {
    var e = Q(c, c.charCodeAt(0), c.charCodeAt(1), c.charCodeAt(2))
    return e !== c + ';'
  ...
  function H(d, c, e, h, a, m, b, v, n, q) {
    for (var g = 0, x = c, w; g < A; ++g)
      switch ((w = T[g].call(B, d, x, e, h, a, m, b, v, n, q))) {
        case void 0:
        case !1:
        case !0:
        case null:
    ...
    switch (d) {
      ...
      default:
        switch (d.constructor) {
          case Array:
            for (var c = 0, e = d.length; c < e; ++c) U(d[c])
            break
          case Function:
            T[A++] = d
            break
  ...
  function V(d) {
    ...
    void 0 !== d &&
      ((S = null),
      d ? ('function' !== typeof d ? (w = 1) : ((w = 2), (S = d))) : (w = 0))
    return V
  }
  function B(d, c) {
    var e = d
