!(function(e, r) {
      ...
      switch (((y = k), (k = _()))) {
        ...
        case 0:
          switch (k) {
            ...
            default:
              if (
                (g((S = D(E, r, t, u, l, a, o, $, (C = []), (A = []), d)), s),
                123 === k)
              )
                if (0 === l) W(E, r, S, S, C, s, d, o, A)
                else
                  switch (h) {
                    case 100:
                    case 109:
  ...
  function D(e, r, t, n, a, s, c, o, u, f, h) {
    for (
      var m = a - 1, g = 0 === a ? s : [''], b = y(g), x = 0, w = 0, k = 0;
      x < n;
      ++x
    )
  ...
  function J(e, r) {
    for (var t = '', n = y(e), a = 0; a < n; a++) t += r(e[a], a, e, r) || ''
    return t
  }
  function X(e, r, t, n) {
    switch (e.type) {
    ...
    switch (typeof t) {
      ...
      case 'object':
        ...
        return (function(e, r, t) {
          var n = ''
          if (Array.isArray(t))
            for (var a = 0; a < t.length; a++) n += de(e, r, t[a]) + ';'
          else
            for (var s in t) {
              var c = t[s]
              if ('object' != typeof c)
  ...
  var ve = function(e, r, t) {
      ...
      null == s || void 0 === s.raw
        ? ((n = !1), (a += de(t, r, s)))
        : (a += s[0])
      for (var c = 1; c < e.length; c++) (a += de(t, r, e[c])), n && (a += s[c])
      he.lastIndex = 0
    ...
    ye = function(e, r) {
      var t = {}
      for (var n in r) re.call(r, n) && (t[n] = r[n])
      return (t[me] = e), t
    },
    ge = ne(function(e, r, n) {
      ...
      var i = ve(
        c,
        void 0,
        'function' == typeof a || Array.isArray(a) ? t.useContext(ae) : void 0
      )
      !(function(e, r, t) {
        var n = e.key + '-' + r.name
        if (
      ...
      o += r.key + '-' + i.name
      var u = {}
      for (var l in e) re.call(e, l) && 'css' !== l && l !== me && (u[l] = e[l])
