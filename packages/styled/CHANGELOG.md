...
- [`a8c99429`](https://github.com/emotion-js/emotion/commit/a8c99429ddb4a2902f06988de302bd8eac542deb) [#1600](https://github.com/emotion-js/emotion/pull/1600) Thanks [@mitchellhamilton](https://github.com/mitchellhamilton)! - TypeScript types have been significantly restructured. These changes:
...
* [`a8c99429`](https://github.com/emotion-js/emotion/commit/a8c99429ddb4a2902f06988de302bd8eac542deb) [#1600](https://github.com/emotion-js/emotion/pull/1600) Thanks [@mitchellhamilton](https://github.com/mitchellhamilton)! - Added `CreateStyled` overload to handle when `shouldForwardProp` is a custom type guard for intrinsic props.
