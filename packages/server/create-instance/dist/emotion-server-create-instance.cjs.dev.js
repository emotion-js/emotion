...
var createRenderStylesToString = function createRenderStylesToString(
  cache,
  nonceString
) {
  return function (html) {
...
var createRenderStylesToNodeStream = function createRenderStylesToNodeStream(
  cache,
  nonceString
) {
  return function () {
    ...
    var inlineStream = through__default['default'](
...
function createEmotionServer(cache) {
  ...
  return {
    ...
    renderStylesToNodeStream: createRenderStylesToNodeStream(
      cache,
      nonceString
    ),
  }
