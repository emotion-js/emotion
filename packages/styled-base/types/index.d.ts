...
export type WithTheme<P, T> =
  P extends { theme: infer Theme } ?
...
export interface StyledComponent<InnerProps, StyleProps, Theme extends object> extends React.SFC<InnerProps & StyleProps & { theme?: Theme }>, ComponentSelector {
  /**
   * @desc
   * `Overwrapped` part checks the compatibility between `StyleProps` and `NewInnerProps`.
   */
  withComponent<NewInnerProps extends Overwrapped<StyleProps, NewInnerProps>>(tag: React.ComponentType<NewInnerProps>): StyledComponent<NewInnerProps, StyleProps, Theme>;

  /**
   * @desc this function overloading is unsafe
   */
  withComponent<NewTag extends keyof JSX.IntrinsicElements>(tag: NewTag): StyledComponent<JSX.IntrinsicElements[NewTag], StyleProps, Theme>;
}

export interface CreateStyledComponentBase<InnerProps, ExtraProps, Theme extends object> {
  <StyleProps extends Overwrapped<InnerProps, StyleProps> = InnerProps & ExtraProps>(
...
export interface CreateStyledComponentIntrinsic<Tag extends keyof JSX.IntrinsicElements, ExtraProps, Theme extends object>
  extends CreateStyledComponentBase<JSX.IntrinsicElements[Tag], ExtraProps, Theme> {}
export interface CreateStyledComponentExtrinsic<Tag extends React.ComponentType<any>, ExtraProps, Theme extends object>
...
export interface CreateStyled<Theme extends object = any> {
  ...
  ): CreateStyledComponentExtrinsic<React.ComponentClass<InnerProps>, ExtraProps, Theme>;
  <InnerProps, ExtraProps = {}>(
